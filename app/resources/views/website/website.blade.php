...
<div class = "head-bottom flex">
    ...
    <p class="text-white">"DR. MAGADAPA ALI RINGIA HOTEL"HIGH IN VALUE LOW IN COST!</p>
    <p>HIGH IN VALUE LOW IN COST!</p>
    <!-- BOOK NOW BUTTON -->
    <!-- <button id="bookBtn" class="btn btn-outline-light " type="button">BOOK NOW</button> -->
   <button id="bookBtn" class="btn btn-outline-warning "  type="button">BOOK NOW</button>
...
@csrf
    ...
    <div class = "form-item">
        ...
        <input type = "number" name="numChildren" min = "0" value = "1" id = "children">
    </div>
